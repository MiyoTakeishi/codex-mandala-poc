        ...
        {Array.from({ length: 9 }, (_, blockIndex) => {
          ...
          return (
            <Box
              ...
              gap="1px"
              bg={isCenterBlock ? "orange.100" : blockTheme.cellBorder}
              borderWidth={{ base: "2px", md: "3px" }}
              borderStyle="solid"
              borderColor={isCenterBlock ? "orange.400" : blockTheme.blockBorder}
              position="relative"
            >
